...
<body style="background-image: url('tempimgs/5.jpg'); background-size:100%;background-repeat: no-repeat; ">
<div class="jumbotron">
  <h1> E-Krushi</h1>
</div>
<form action="del.php" method="post">
<input type="text" name="search_key" placeholder="Search for the item"  required="">
<center><button class="btn" type="submit" name="search">submit</button></center></br></br>
</form>
</html>
